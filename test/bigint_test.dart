...
main() {
  ...
  test("BigInt to Bytes conversion", () {
  ...
  try {
    try {
      test("x509 public key certificate", () {
        ...
        //modulus
        // The old test represented this a dart num type, not a string
        // Dart 2 num is now restricted - so this code is not working..
        ...
        //BigInteger expectedModulos = new BigInteger(modstring, 10);
        //var x = BigInt.parse(modstring,radix: 10);
        ...
        //var y = (seq.elements[0] as ASN1Integer).intValue;
